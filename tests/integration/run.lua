...
local defaultTestFiles = {
	...
	"tests/integration/pushable_destructible_tile_fall_test.lua",
	...
	"tests/integration/pickup_destructible_tile_fall_test.lua",
	...
	"tests/integration/switch_start_on_test.lua",
	...
	"tests/integration/bird_target_flight_test.lua",
	"tests/integration/bird_door_exit_test.lua",
	"tests/integration/bird_terrain_passthrough_test.lua",
	...
	"tests/integration/laser_blocking_test.lua",
	"tests/integration/laser_kill_test.lua",
