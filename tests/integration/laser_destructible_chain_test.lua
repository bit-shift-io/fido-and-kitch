...
test(
	"a chainBreak tile destroyed by a beam cascades hop-by-hop through the chain, sparing diagonals and stopping at a capped tile",
	function()
		...
		assertTrue(
			Queries.findEntityByName(map, "tile_chain_c_capped") ~= nil,
			"expected the fixture to load tile_chain_c_capped"
		)
		assertTrue(
			Queries.findEntityByName(map, "tile_beyond_capped") ~= nil,
			"expected the fixture to load tile_beyond_capped"
		)
		assertTrue(
			Queries.findEntityByName(map, "tile_cross_north") ~= nil,
			"expected the fixture to load tile_cross_north"
		)
		assertTrue(
			Queries.findEntityByName(map, "tile_diagonal_untouched") ~= nil,
			"expected the fixture to load tile_diagonal_untouched"
		)
		...
		assertTrue(
			Queries.findEntityByName(map, "tile_chain_a") == nil,
		...
		assertTrue(
			Queries.findEntityByName(map, "tile_chain_b") ~= nil,
