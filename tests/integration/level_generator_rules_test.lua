...
test('a difficulty-5 generated level loads with real switch/teleport/jump_pad entities, still completable ignoring them', function()
	...
	local ok, err = pcall(function()
		...
		assertTrue(exitDoors[1].usable.enabled, 'expected the exit to open from cages alone, ignoring every flourish')
	end)
