...
local function test_npcs_canPushEachOther()
    ...
    local spider = NPCRegistry.spawn('npc_spider', {x = 0, y = 0}, {canPush = true, canBePushed = true, pushForce = 200})
    local robot = NPCRegistry.spawn('npc_robot', {x = 50, y = 0}, {canPush = true, canBePushed = true, pushForce = 200})
...
local function test_npc_pushesPlayer()
    ...
    local spider = NPCRegistry.spawn('npc_spider', {x = 0, y = 0}, {canPush = true, pushForce = 200})
    local rabbit = NPCRegistry.spawn('npc_rabbit', {x = 40, y = 0}, {canBePushed = true})
...
local function test_rabbit_ridesMovingPlatform()
    ...
    local rabbit = NPCRegistry.spawn('npc_rabbit', {x = 0, y = 0}, {ridePlatforms = true})
...
local function test_robot_triggersSwitch()
    ...
    local robot = NPCRegistry.spawn('npc_robot', {x = 0, y = 0}, {triggerSwitches = true})
...
local function test_spider_doesNotTriggerSwitch()
    ...
    local spider = NPCRegistry.spawn('npc_spider', {x = 0, y = 0}, {triggerSwitches = false})
    local switch = {x = 30, y = 0, isSwitch = true, activated = false, activate = function(self, by) self.activated = true end}
...
local function test_npc_collisionWithSolidWall()
    ...
    local spider = NPCRegistry.spawn('npc_spider', {x = 0, y = 0})
