...
test("pressing down on a platform flush above an off-centre ladder mounts and descends without jittering", function()
	...
	assertEqual(
		...
		"fixture check: expected the player to have settled on the platform, not already on the ladder"
	)
	...
	assertFalse(
		bouncedOffAfterMounting,
		"expected the player to stay mounted on the ladder, not bounce back off while still holding down"
	)
