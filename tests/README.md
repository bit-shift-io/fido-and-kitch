...
All of the above were found by `tests/e2e/drawbridge_test.lua` and `tests/integration/drawbridge_test.lua` — real physics (and, for the last one, a real fall all the way to a kill zone) surfaced them; a narrower headless check could not.
