...
local function makeMachine()
	...
	local states = {
		A = {
			enter = function() table.insert(calls, 'A enter') end,
			update = function() end,
		},
		B = {
			canTransition = function() return true end,
			enter = function() table.insert(calls, 'B enter') end,
			update = function() end,
		},
		C = {
			canTransition = function() return false end,
			update = function() end,
		},
	}
