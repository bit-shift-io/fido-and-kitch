...
test("stops before entering a static solid collider partway along the path", function()
	...
	local overlapsWall = bounds.left < wallBounds.right
		and bounds.right > wallBounds.left
		and bounds.top < wallBounds.bottom
		and bounds.bottom > wallBounds.top
	...
	local overlapsAfter = boundsAfter.left < wallBounds.right
		and boundsAfter.right > wallBounds.left
		and boundsAfter.top < wallBounds.bottom
		and boundsAfter.bottom > wallBounds.top
...
test("stops before entering a pushable-equivalent dynamic collider", function()
	...
	local overlaps = bounds.left < pushableBounds.right
		and bounds.right > pushableBounds.left
		and bounds.top < pushableBounds.bottom
		and bounds.bottom > pushableBounds.top
