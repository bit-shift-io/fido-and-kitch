...
local SPRITE_SPECS = {
	{
		tj = "res/entities/teleport.tj",
		type = "teleport",
		image = "res/img/entity_teleporter.png",
		frames = 1,
	},
	{
		tj = "res/entities/exit_door.tj",
		type = "exit_door",
	...
	{
		tj = "res/entities/story.tj",
		type = "story",
		image = "res/img/entity_wood_sign_post.png",
		frames = 1,
	},
	{
		tj = "res/entities/spawn.tj",
		type = "spawn",
		image = "res/img/default.png",
		frames = 1,
	},
	{
		tj = "res/entities/replicator.tj",
		type = "replicator",
		image = "res/img/entity_replicator.png",
		frames = 1,
	},
	{
		tj = "res/entities/push_box.tj",
		type = "push_box",
		image = "res/img/pushable_crate_wood.png",
		frames = 1,
	},
	{
		tj = "res/entities/drawbridge.tj",
		type = "drawbridge",
	...
	{
		tj = "res/entities/mover_platform.tj",
		type = "mover_platform",
		image = "res/img/entity_mover_platform.png",
		frames = 1,
	},
	{
		tj = "res/entities/cage.tj",
		type = "cage",
	...
	{
		tj = "res/entities/boulder.tj",
		type = "boulder",
		image = "res/img/pushable_stone_block.png",
		frames = 1,
	},
	{
		tj = "res/entities/key.tj",
		type = "key",
		image = "res/img/entity_key.png",
		frames = 1,
	},
	{
		tj = "res/entities/flag.tj",
		type = "flag",
		image = "res/img/entity_flag.png",
		frames = 1,
	},
	{
		tj = "res/entities/jump_pad.tj",
		type = "jump_pad",
	...
	{
		tj = "res/entities/pressure_switch.tj",
		type = "pressure_switch",
		image = "res/img/entity_pressure_switch.png",
		frames = 1,
	},
}
