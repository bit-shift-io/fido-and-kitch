...
**Status:** Accepted (drawbridge's and pressure_switch's own splits reversed by ADR 0005; the directory convention documented here still applies to any other multi-file entity, e.g. pushable)
**Date:** 2026-07-26
