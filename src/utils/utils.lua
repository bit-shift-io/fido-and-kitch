			...
			local hasMethod = mt
				and (
					...
					or (
						mtIndex
						and (
							type(mtIndex) == "table" and mtIndex[func]
							or type(mtIndex) == "function" and mtIndex(from, func)
						)
					)
				)
			if hasMethod then
				return mt[func]
					or (mtIndex and type(mtIndex) == "table" and mtIndex[func])
					or (mtIndex and type(mtIndex) == "function" and mtIndex(from, func))
			end
