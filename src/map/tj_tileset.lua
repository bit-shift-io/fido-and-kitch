-- Resolves a Tiled external tileset (.tsj) into a table shaped exactly like
...
-- Resolved tilesets keyed by path, for the process lifetime --
...
--- Resolve an external .tsj tileset to an STI-shaped tileset table.
-- @param path Path to the .tsj file, as it would be opened from the
...
function TjTileset.resolve(path, firstgid, deps)
	deps = deps or {}
